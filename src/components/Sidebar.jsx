const SideBar = () => {
  return (
    <>
      <section className="w-[5vw] bg-black h-screen float-start">
        <div className="grid-rows-2">
          <div className="bg-black h-[50vh] grid grid-rows-3 place-items-center">
          ...
          <div className="bg-black h-[50vh] grid grid-rows-1 place-items-center">
